...
<br>
**Rutvi**:<br>
This lab on mutation testing and GUI testing effectively covers two crucial aspects of software testing, it was a bit lengthy and time-consuming as well. Part one provides a hands-on experience with mutation testing, teaching us how to inject faults into Java code and interpret mutation scores to enhance test suite quality. Part two introduces GUI testing using Selenium IDE, a widely used tool for web interface testing.I personally think, it would be beneficial to ensure clarity in instructions and provide ample resources for further exploration and understanding. Overall, it's a well-rounded lab that equips students with practical skills in software testing methodologies.
<br>
**Angelo**:<br>
