...
public class DataUtilitiesTest extends DataUtilities {
	 ...
	 * 
	 * A4 - changed to test for IllegalArgumentException
	 */
	@Test
	 ...
	 * Expected result: InvalidParameterException thrown
	 * 
	 * A4 - test changed to test for IllegalArgumentException
	 */
	@Test
	 ...
	 * Expected result: InvalidParameterException thrown
	 * 
	 * A4 - changed to check for IllegalArgumentException
	 */
	@Test
	public void testCreateNumberArrayNullData() {
		...
		Number [] x= DataUtilities.createNumberArray(null);
			...
			assertTrue("Class is of type" +e.getClass().toString(),e instanceof IllegalArgumentException);
		}
	}
...
* Expected result: InvalidParameterException thrown
* 
* A4 - test changed to seek for IllegalArgumentException
*/
@Test
